...
1. Ler o conteúdo produzido pelo primeiro prompt e localizar a tag <objetos_relacionados>.
2. Extrair cada linha dessa tag, interpretando o primeiro campo como id, o segundo como category e o terceiro como object.
3. Retornar **exclusivamente** um objeto JSON no seguinte formato:
...
- Se a tag <objetos_relacionados> estiver vazia, retorne selectedObjects como um array vazio.
- Não inclua explicações adicionais, apenas o JSON resultante com os campos preenchidos fielmente de acordo com o que foi identificado na análise anterior (sem modificações de texto ou reordenações).

---

#### Exemplo 1

**Como ficaria dentro de <objetos_relacionados>**:

<objetos_relacionados>
1234-5678-aaaa-bbbb // Categoria Exemplo A // Objeto de Conhecimento Exemplo A
9876-5432-zzzz-yyyy // Categoria Exemplo B // Objeto de Conhecimento Exemplo B
4321-8765-cccc-dddd // Categoria Exemplo C // Objeto de Conhecimento Exemplo C
</objetos_relacionados>
...

{
  "selectedObjects": [
    {
      "id": "1234-5678-aaaa-bbbb",
      "category": "Categoria Exemplo A",
      "object": "Objeto de Conhecimento Exemplo A"
    },
    {
      "id": "9876-5432-zzzz-yyyy",
      "category": "Categoria Exemplo B",
      "object": "Objeto de Conhecimento Exemplo B"
    },
    {
      "id": "4321-8765-cccc-dddd",
      "category": "Categoria Exemplo C",
      "object": "Objeto de Conhecimento Exemplo C"
    }
  ]
}
